...
|---|---|---|
| 1 | Agente autónomo básico (Tools Agent) - Asistente de Calificación de Leads | [`checkpoint1/checkpoint1_nombre_apellido.json`](./checkpoint1/checkpoint1_nombre_apellido.json) |
